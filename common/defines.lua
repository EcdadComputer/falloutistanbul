...
NEconomy = {
	...
	LAND_MAINTENANCE_FACTOR = 1,					-- _EDEF_LAND_MAINTENANCE_FACTOR
	HEAVY_SHIP_MAINT_FACTOR = 0.60,					-- _EDEF_HEAVY_SHIP_MAINT_FACTOR_
	LIGHT_SHIP_MAINT_FACTOR = 0.12,					-- _EDEF_LIGHT_SHIP_MAINT_FACTOR_
	GALLEY_MAINT_FACTOR = 0.16,						-- _EDEF_GALLEY_MAINT_FACTOR_
	TRANSPORT_MAINT_FACTOR = 0.16,					-- _EDEF_TRANSPORT_MAINT_FACTOR_
	...
	MISSIONARY_MAINTENANCE_AUTONOMY_FACTOR = 2.0,		-- How much this is ncreased from local autonomy
	MISSIONARY_MAINTENANCE_AUTONOMY_BASE = 2.0,			-- The local autonomy is added to this base in the formula.
	MISSIONARY_MAINTENANCE_DEVELOPMENT_CAP = 100,				-- Where dev will get capped by the system for calculations.
	MERCHANT_TIME_DISTANCE = 0.10,					-- _EDEF_MERCHANT_TIME_DISTANCE_
...
NFrontend = {
	CAMERA_LOOKAT_X = 2000.0, 						-- Rotation point in main menu
	CAMERA_LOOKAT_Y = 0.0,
	CAMERA_LOOKAT_Z = 600.0,
	CAMERA_LOOKAT_SETTINGS_X = 2000.0, 				-- Rotation point in settings
	CAMERA_LOOKAT_SETTINGS_Y = 0.0,					-- Y is height
	CAMERA_LOOKAT_SETTINGS_Z = 500.0,
	CAMERA_START_X = 2000.0,						-- Initial position in main menu
	CAMERA_START_Y = 800,							-- Y is height
	CAMERA_START_Z = 500.0,
	CAMERA_END_X = 2000.0,							-- Move to position in main menu
	CAMERA_END_Y = 900.0,
	CAMERA_END_Z = 500.0,
	...
	FRONTEND_POS_X = 2000.0,
	FRONTEND_POS_Y = 900.0,
	FRONTEND_POS_Z = 500.0,
	FRONTEND_LOOK_X = 2000.0,
	FRONTEND_LOOK_Y = 0.0,
